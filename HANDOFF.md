...
**1157 首歌曲 / 3325 次演唱 / 921 个 B站歌切匹配**，时间跨度 **2022.09 – 2026.09**。
...
- **导出**（数据导出）
- **外链**（相关外部链接）
- **页脚时间范围**：`2022.09 – 2026.09`（如改版动到页脚请保持这个跨度）
...
【必须保留的功能】搜索（歌名/译名/原唱）、语言与次数筛选、B站歌切播放、热度图、盲盒、投稿入口、导出、外链、页脚时间范围（2022.09 – 2026.09）。
...
【当前规模】1157 首歌曲 / 3325 次演唱 / 921 歌切匹配 / 跨度 2022.09 – 2026.09 / 单文件约 704KB。
