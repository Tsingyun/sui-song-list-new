...
.search-box input{width:100%;border:none;border-bottom:2px solid var(--magenta);background:rgba(0,0,0,.55);backdrop-filter:blur(10px);color:var(--cyan);font-family:var(--font-m);font-size:15px;padding:10px 14px 10px 36px;outline:none;transition:all .2s}
