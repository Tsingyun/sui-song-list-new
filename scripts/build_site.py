...
@media(hover:none){
  .song-row,.play-btn,.filter-btn,.blindbox-btn,.back-top,.contribute-btn,.export-btn,.stats-link,.section-tab,.detail-copy-btn,.detail-link,.detail-bili-item{transition:transform .12s ease,box-shadow .2s ease,background .2s ease}
  .play-btn:active,.filter-btn:active,.blindbox-btn:active,.back-top:active,.contribute-btn:active,.export-btn:active,.stats-link:active,.section-tab:active,.detail-copy-btn:active{transform:scale(.92);box-shadow:0 0 16px rgba(0,255,255,.5)}
...
.detail-copy-btn{font-family:var(--font-cjk);font-size:11px;padding:4px 12px;margin-top:6px;border:1px solid var(--cyan);background:transparent;color:var(--cyan);border-radius:4px;cursor:pointer;transition:all .2s}
.detail-copy-btn:hover{background:var(--cyan);color:#000}
.detail-bili-item{
