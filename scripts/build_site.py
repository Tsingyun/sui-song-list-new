...
@media(max-width:768px){
  ...
  .section-tabs{overflow-x:auto;-webkit-overflow-scrolling:touch;flex-wrap:nowrap;scrollbar-width:none}
  ...
  .player-panel{left:10px!important;right:10px;width:auto;bottom:10px}
...
@media(max-width:640px){
  ...
  .song-row .name{grid-area:name;font-size:14px;padding:0;overflow:visible}
  .song-row .name .song-title{white-space:normal}
  .song-row .name .song-title small{font-size:10px}
  .song-row .play-btn{grid-area:play;width:30px;height:30px;font-size:12px;align-self:center}
  ...
  .song-row .tag-badge{font-size:7px;padding:1px 3px;border-radius:2px}
  ...
  .back-top{bottom:18px;right:14px;width:42px;height:42px;font-size:16px}
  .contribute-btn{bottom:70px;right:14px;font-size:11px;padding:9px 13px;letter-spacing:1px}
  .export-btn{bottom:120px;right:14px;font-size:11px;padding:9px 13px;letter-spacing:1px}
  .stats-link{bottom:170px;right:14px;font-size:11px;padding:9px 13px;letter-spacing:1px}
  ...
  .cl-date{min-width:64px;font-size:9px}
...
@media(max-width:360px){
  ...
  .song-row .play-btn{width:28px;height:28px}
  ...
  .contribute-btn{bottom:66px}
  .export-btn{bottom:114px}
  .stats-link{bottom:162px}
...
<div class="container">
  ...
  <div class="footer">
    ...
    <p><span class="ver-badge">界面版本 v2.1</span></p>
