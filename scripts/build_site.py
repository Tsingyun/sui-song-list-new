...
.song-row{display:grid;grid-template-columns:54px 36px 1fr 100px 80px 60px 90px;align-items:center;border-bottom:1px solid rgba(45,27,78,.4);transition:all .15s;cursor:default;opacity:0;transform:translateX(-8px)}
...
document.addEventListener('click',e=>{
  ...
  const lastDate=rawDate.replace(/ 共\d+次$/,'').trim();
