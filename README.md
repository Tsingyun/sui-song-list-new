...
> **SUI_SONG_DATABASE V4.0** — 为虚拟主播 [岁己SUI](https://space.bilibili.com/1954091502) 打造的 Vaporwave 风格歌单网站，配有岁己SUI角色插画背景
...
+ 单文件 HTML 架构
  ...
  - 文件体积约 695 KB（含 1158 首歌曲完整数据 + 1235 首日期记录 + 背景插画 WebP）
