...
- **数据规模**: 1161首歌曲、3338次演唱记录、923首歌有B站录播匹配（截至 2026-07-25）
...
├── data/
│   ├── song_data.json                  ← 核心数据库（1161首歌曲，含 stats、lang_counts 和 tags）
...
└── docs/
    ├── index.html                      ← 最终网站（~726KB，由 build_site.py 生成）
...
```json
{
  "stats": { "total": 1161, "performances": 3338, "frequent": 239, "occasional": 433, "once": 489 },
