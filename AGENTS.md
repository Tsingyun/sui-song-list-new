...
- **数据规模**: 1167首歌曲、3387次演唱记录、932首歌有B站录播匹配（截至 2026-09-06）
...
├── data/
│   ├── song_data.json                  ← 核心数据库（1167首歌曲，含 stats、lang_counts 和 tags）
...
```json
{
  "stats": { "total": 1167, "performances": 3387, "frequent": 241, "occasional": 434, "once": 492 },
