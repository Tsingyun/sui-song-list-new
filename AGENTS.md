...
- **数据规模**: 1166首歌曲、3377次演唱记录、932首歌有B站录播匹配（截至 2026-08-25）
...
├── data/
│   ├── song_data.json                  ← 核心数据库（1166首歌曲，含 stats、lang_counts 和 tags）
...
```json
{
  "stats": { "total": 1166, "performances": 3377, "frequent": 239, "occasional": 435, "once": 492 },
