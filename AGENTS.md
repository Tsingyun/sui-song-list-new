...
- **数据规模**: 1159首歌曲、3333次演唱记录、921首歌有B站录播匹配（截至 2026-07-17）
...
│   ├── song_bilibili_map.json          ← 歌曲-视频匹配结果（921首歌）
...
```json
{
  "stats": { "total": 1159, "performances": 3333, "frequent": 238, "occasional": 433, "once": 488 },
