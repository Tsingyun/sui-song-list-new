...
- **数据规模**: 1157首歌曲、3325次演唱记录、921首歌有B站录播匹配（截至 2026-07-17）
...
├── data/
│   ├── song_data.json                  ← 核心数据库（1157首歌曲，含 stats、lang_counts 和 tags）
...
```json
{
  "stats": { "total": 1157, "performances": 3325, "frequent": 238, "occasional": 432, "once": 487 },
